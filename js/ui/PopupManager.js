...
${returnShape}
    ...
    // --- Slider Form Modal (Grasshopper Style) ---
    showSliderForm(sliderInstance, onSave) {
        this.overlay.innerHTML = '';
        this.overlay.style.alignItems = 'center';
        this.overlay.style.justifyContent = 'center';
        ...
        const saveFn = () => {
            ...
            // Calculate step based on precision if R
            if (finalConfig.rounding === 'R') {
                ...
                // If Integer, ensure value is int
        ...
        modal.querySelector('#btn-save').addEventListener('click', saveFn);
